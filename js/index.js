let items = [
    ...
    {name: "ASUS TUF Gaming A16 (2025) FA608UM-RV015 (90NR0KV1-M00880) Jaeger Gray / 16*\" IPS WUXGA 165Hz / AMD Ryzen 7 260 / 16GB RAM / 1TB SSD / GeForce RTX 5060, 8GB (TDP 115W)", price: 1500, img: "image/Gaming_laptop.png"}
];
let cart = [];
function showProducts() {
    ...
    items.forEach((item, i) => {
        out += `<div class="product">
                    ...
                    <button onclick="addToCart(${i})">Добавить в корзину</button>
                </div>`;
    });
...
function updateCart() {
    ...
    cart.forEach((item, i) => {
        out += `<div class="cart-item">
                    ...
                    <span>${item.price * item.qty} € <button class="remove-btn" onclick="removeFromCart(${i})">Удалить</button></span>
                </div>`;
    });
